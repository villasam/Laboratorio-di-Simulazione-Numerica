...
private:
  ...
  string _run_name;     // Name of the current run
  string _input_dir;    // Directory for input files of the current run
  string _output_dir;   // Directory for output files of the current run
  string _config_mode;       // STANDARD, FCC_FULL_BOX, FCC_HALF_BOX
  string _velocity_mode;     // MAXWELL, DELTA_AXES
  ...
  double _v_max;         // Maximum velocity for velocity modulus distribution
...
public: // Function declarations
  System(string run_name);               // Constructor with run-dependent paths
  string input_path(string filename);     // Build path to input file
  string output_path(string filename);    // Build path to output file
